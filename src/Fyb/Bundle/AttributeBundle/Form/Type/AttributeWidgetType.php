...
//        ));
        ...
        $formModifier = function (FormInterface $form, $data = null) {
            ...
            if ($data instanceof Attribute) {
                ...
                $frontendChoices = call_user_func(array("Fyb\\Component\\Attribute\\AttributeType\\".$attributeType, 'getFrontendWidgetChoicesList'));
                $backendChoices = call_user_func(array("Fyb\\Component\\Attribute\\AttributeType\\".$attributeType, 'getBackendWidgetChoicesList'));
            }
